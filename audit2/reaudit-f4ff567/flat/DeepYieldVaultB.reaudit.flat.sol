...
contract DeepYieldVaultB is ERC4626, AccessControlDefaultAdminRules, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        // accept-required transfer. Guardian membership remains recoverable by that
        // delayed default admin so a lost or renounced final guardian cannot disable
        // every pause-gated recovery path forever.
