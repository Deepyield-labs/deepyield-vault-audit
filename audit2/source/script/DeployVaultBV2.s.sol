...
import {FixedFeeSink} from "../src/FixedFeeSink.sol";
...
contract DeployVaultBV2 is Script {
    ...
    function run(string memory configPath) external {
        ...
        console.log("FEE_SINK=%s", a.feeSink);
    ...
    function _deploy(Config memory cfg, address deployer) public returns (Addresses memory a) {
        ...
        // retains normal protocol-fee inventory.
        FixedFeeSink feeSink = new FixedFeeSink(IERC20(USDT), cfg.projectTreasury, cfg.admin);
